...
For more information about this software, please read the documentation on [http://www.sweetohm.net/bee/](http://www.sweetohm.net/bee/) or see **bee** section on Gem server (type `gem_server` and go at URL [http://localhost:8808](http://localhost:8808)) if you installed it using Gem.

License
-------

bee is Open Source and released under the [Apache License](http://www.apache.org/licenses/LICENSE-2.0).
